...
**Authority:** SD v1.3 §8.1–§8.3, §14 不变量 1–14; DID v1.9 §6.2 Enforcement Matrix, §1.4A, §4.1(P2 authority facts), §12.10; P1 `01` §2A/§9, P2 `01` §2A.
...
深层自主 formation（01 §4.3）与 specialist spawn（01 §3）中，command 的 trusted authority fact 由 Application 从 Execution 上下文投影：
...
- 对 `RecordDecision`（D1 第一层链）：authority 为 `AuthenticatedHuman` principal（DID §8.4A provenance 体系）；agent 不能替人裁决 formation。
