...
|---|---|---|
| P0 | Functional Domain Kernel | IN PROGRESS — P0-001, P0-002, P0-003 complete; environment baseline via pinned container |
...
P0-001 … P0-003 are complete (`planning/results/`).
