...
|---|---|---|
| P0 | Functional Domain Kernel | IN PROGRESS — P0-001–P0-005, P0-007 complete; environment baseline via pinned container |
...
P0-001–P0-005 and P0-007 are complete (`planning/results/`).
