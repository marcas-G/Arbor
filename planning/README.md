...
|---|---|---|
| P0 | Functional Domain Kernel | IN PROGRESS — P0-001–P0-007, P0-009–P0-015 complete; environment baseline via pinned container |
...
P0-001–P0-007 and P0-009–P0-015 are complete (`planning/results/`).
