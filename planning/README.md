...
|---|---|---|
| P0 | Functional Domain Kernel | IN PROGRESS — P0-001–P0-005, P0-007, P0-010–P0-012 complete; environment baseline via pinned container |
...
P0-001–P0-005, P0-007, and P0-010–P0-012 are complete (`planning/results/`).
