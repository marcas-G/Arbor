...
| P12 | Production / Extensibility | COMPLETE — P12-001 … P12-013 done; design closure COMPLETE; planning COMPLETE; implementation authorized and COMPLETE; see planning/results/P12.result.md |
...
P12 is COMPLETE (`planning/results/P12.result.md`).
