...
|---|---|---|
| P0 | Functional Domain Kernel | IN PROGRESS — P0-001, P0-002 complete; environment baseline via pinned container |
...
P0-001 and P0-002 are complete (`planning/results/`).
