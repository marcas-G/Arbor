...
**Authority:** DID v1.10 §11 P8（关键词）, §4.2 CompletedResult `QueryCompleted`:1107/1882/3850; §8.4 P14 Query/Inspection Program; PG non-goal:266; SD §12.5:1329。
...
DEFER P14 Program 到 P10/P12（若治理认为查询行为协议在 projection/生产化阶段定型更合适）；实体化（新 aggregate）被否决——与 §1.6 及 PG non-goal 冲突。
