# P8 — 04 Evidence & Version Binding (PROPOSAL)

**Authority:** DID v1.10 §3.5:1161-1185, §3.7:1237, §8.4A, §12.8 C7; SD v1.3 §9.2/§9.5/§9.6; 不变量 26/27/44/49; P4 blob/artifact 基建; P7 `01` §3（Deliverable 不可变）; P6 `01` §2（占位 mission）。
**Status:** DESIGN CLOSURE DRAFT（GQ2 关联）。
...
## 2. Criterion 级 verdict（GQ2 推荐形态：value object，不动聚合）
