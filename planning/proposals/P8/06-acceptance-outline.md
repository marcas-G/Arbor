# P8 — 06 Acceptance Outline (PROPOSAL)

**Authority:** S1 步骤 9–11, S3 步骤 11–12; DID v1.10 §11 P8; P6/P7 验收风格先例。
**Status:** DESIGN CLOSURE DRAFT（概要；冻结版随契约落位定稿）。
...
- **Story F — Program 版本纪律**：P9 Verification Program（+P14 若 GQ1 采纳）v1 头字段/hash/eval 门/篡改负例（P6 D4 模式复制）。
